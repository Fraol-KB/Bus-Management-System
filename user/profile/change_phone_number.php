                                ...
                                <div class="col-lg-6">
                                    <form method="get" role="form" action="profile_controller.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="new_phone_number" pattern=".{10,}" title="10 characters minimum" type="tel" class="form-control" placeholder="Enter New Phone Number" required>
                                        </div>


                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <button type="reset" class="btn btn-danger">Reset</button>
                                        <input type="hidden" name="type" value="change_phone_number">
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
