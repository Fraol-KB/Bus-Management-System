                                ...
                                <div class="col-lg-6">
                                    <form method="get" role="form" action="driver_controller.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input name="driver_name" type="text" class="form-control" placeholder="Enter Driver Name" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Phone Number</label>
                                            <input name="driver_phone_number" pattern=".{10,}" maxlength="10" type="tel" class="form-control" placeholder="Enter Phone Number" required>
                                        </div>
