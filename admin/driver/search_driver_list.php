                ...
                <div class="col-lg-12">
                    <div class="col-lg-12">
                        ...
                        <tr>
                                    ...
                                    $driver_list = $_SESSION['search_list'];
                                        for($i=0; $i < count($driver_list); $i++){
                                            ...
                                            echo "<td>".$driver_list[$i]['id']."</td>";
                                            echo "<td>".$driver_list[$i]['name']."</td>";
                                            echo "<td>".$driver_list[$i]['phone_number']."</td>";
                                            echo "<td>".$driver_list[$i]['is_assigned']."</td>";
  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <a href='driver_controller.php?type=delete&driver_id=".$driver_list[$i]['id']."' class='btn btn-danger'>Yes</a>
