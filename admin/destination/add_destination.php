                ...
                <div class="col-lg-7">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="get" role="form" action="destination_controller.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Destination Name</label>
                                            <input name="destination_name" type="text" class="form-control" placeholder="Enter Destination Name" required>
                                        </div>
