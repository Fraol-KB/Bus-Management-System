                                ...
                                <div class="col-lg-6">
                                    <form method="get" role="form" action="coupon_controller.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input name="no_of_coupons" type="number" min="1" max="1000" class="form-control" placeholder="Enter Number of Coupons" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Value of Coupons</label>
                                            <input name="value_of_coupons" type="number" min="1" max="10000" class="form-control" placeholder="Enter Value of Coupons" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Coupon Prefix</label>
                                            <input name="coupon_prefix" type="text" class="form-control" placeholder="Coupon Prefix" required>
                                        </div>
