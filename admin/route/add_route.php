                ...
                <div class="col-lg-7">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="get" role="form" action="route_controller.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Add Route</label>

                                        </div>
                                            <div class="form-group">
                                                <label for="select_origin">Starting From</label>
                                                <select id='select_origin' class="form-control" name="origin_id">
                                                    <?php
                                                    for($i=0; $i < count(Origin::get_all_origins()); $i++){

                                                        echo "<option value='".Origin::get_all_origins()[$i]['id']."'>".Origin::get_all_origins()[$i]['name']."</option>";
                                            ...
                                            <div class="form-group">
                                                <label for="select_destination">Going To</label>
                                                <select id='select_destination' class="form-control" name="destination_id">
<!--                                                    --><?php
                                                    for($i=0; $i < count(Destination::get_all_destinations()); $i++){

                                                        echo "<option value='".Destination::get_all_destinations()[$i]['id']."'>".Destination::get_all_destinations()[$i]['name']."</option>";
                                            ...
                                            <div class="form-group">
                                                <label>Length</label>
                                                <input name="length" type="number" min="1" class="form-control" placeholder="Enter Length" required>
                                            </div>
                ...
                <?php
                    if(isset($_GET['route_error'])){
                        echo '<div class="col-lg-5">
                    <div class="alert alert-danger alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        You cannot have the same Origin and Destination.
                    </div>
                </div>';
                    }
                ?>
