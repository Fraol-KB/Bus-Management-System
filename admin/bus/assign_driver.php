...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Assign Driver</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-7">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="get" role="form" action="bus_controller.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Bus</label>
                                            <p class="form-control-static">Plate Number - <?php echo Bus::get_bus_by_id($_GET['bus_id'])['plate_number'];?></p>
                                        </div>
                                        <div class="form-group">
                                            <label for="select_driver">Drivers</label>
                                            <select id='select_driver' class="form-control" name="driver_id">
                                                <?php
                                                for($i=0; $i < count(Driver::get_all_unassigned_drivers()); $i++){

                                                    //echo    var_dump(Bus::get_all_buses());

                                                    echo "<option value='".Driver::get_all_unassigned_drivers()[$i]['id']."'>".Driver::get_all_unassigned_drivers()[$i]['name']."</option>";
                                        ...
                                        <input type="hidden" name="type" value="assign_driver">
