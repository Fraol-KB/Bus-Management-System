                                ...
                                <div class="col-lg-6">
                                    <form method="get" role="form" action="bus_controller.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input name="plate_no" type="text" class="form-control" placeholder="Enter Plate Number" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Number of Seats</label>
                                            <input name="no_of_seats" type="number" min="1"  max="100" class="form-control" placeholder="Enter Number of Seats" required>
                                        </div>
